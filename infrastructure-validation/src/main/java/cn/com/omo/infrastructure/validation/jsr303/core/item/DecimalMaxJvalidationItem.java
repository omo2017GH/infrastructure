 ...
 * @since 1.0
 */
public class DecimalMaxJvalidationItem extends BaseDecimalJvalidationItem {

    public DecimalMaxJvalidationItem(BigDecimal itemValue, boolean inclusive, String message) {
